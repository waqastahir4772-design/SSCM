...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_partner'])) {
    ...
    $store = escape($_POST['store_type'] ?? '');
    
    $sql = "INSERT INTO scm_partners (name, code, type, contact_person, phone, email, store_type, status) 
            VALUES ('$name', '$code', '$type', '$contact', '$phone', '$email', '$store', 'Active')";
    
    if ($conn->query($sql)) {
        redirect('retailers.php', "$type added successfully!");
    } else {
      ...
      <form action="" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="store_type" class="form-control" placeholder="e.g. Stationery, Uniform Shop">
          </div>
        </div>
